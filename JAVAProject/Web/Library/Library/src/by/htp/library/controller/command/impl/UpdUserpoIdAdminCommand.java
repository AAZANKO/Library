...
public class UpdUserpoIdAdminCommand implements Command {
	
	public UpdUserpoIdAdminCommand() {}
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// сохранение изменений отредактированного пользователя
		...
		try {
			user = userService.admineditusertable(this.id, this.firstName, this.lastName, this.midleName, this.login,
			...
			if (user != null) {
				...
				request.setAttribute("message", "Пользователь успешно обновлен");
